...
function updatePostDataResponse(response, postType) {
	...
	if (response == 'error') {
		...
		content = 'আপনার লেখাটি <a href="/' + postType + '/' + response + '">এখানে পাবলিশ</a> হয়েছে, মুল পাতা ও অন্যান্য পাতায় শীঘ্রই চলে আসবে, বিশ্লেষনের জন্য বেশ কয়েক মিনিট সময় লাগতে পারে।';
	}
